...
| `docs/ADOPTION_REQUIREMENTS.md` | Backlog source of truth | Updated | R11 and R13 complete. | R12 is next. | Continue Tier 2. |
| `internal/vector/store.go` | Provider-neutral deterministic vector state/ranking | Added | Bounded collections, lazy Chroma dimensions, atomic upsert, filters, stable ties, fixtures, namespaces, and partial truncation. | Persistence remains process-local by design. | Maintain provider contracts. |
