...
| Qdrant/Pinecone/Chroma HTTP -> shared vector store -> RAG demo | config loader, startup seeding, adapter registry, provider handlers, vector core, Python demo | Pass | Recursive fixtures, namespaces, CRUD/search/stats, partial signaling, and one-server demo path are covered. | Python E2E awaits CI runtime locally. | Maintain R11. |
...
- P1 completed: R11 ships the reusable core, all three provider profiles, failure fixtures, and migrated RAG demo.
