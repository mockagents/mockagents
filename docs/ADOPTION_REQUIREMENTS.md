...
| R20 | **In progress:** migration guides and converters. `mockagents convert aimock` converts the safely representable AIMock JSON fixture subset to a validated Agent YAML file and reports unsupported matchers rather than broadening them. vcrpy + OpenAI-stored cassette importers already exist; the remaining framework migration guides follow. | After Tier 1 lands | FR-K04 + PMF F8 |
