...
// Query parameters:
//
//	kind    one of tenant.created|tenant.deleted|api_key.created|api_key.deleted|api_key.role_changed|api_key.rotated|agent.reloaded|agent.created|agent.updated|agent.deleted|pipeline.saved|auth.denied
