...
- [ ] `F-CH-003` lock only around RNG draws · `F-CH-004` clamp `rate` · `F-CH-006` note bucket growth · ~~`F-AR-004`/`F-PR-002` nil-`def` guards~~ ✅ (see nil-guard cluster below) · `F-PR-003` note List cost · `F-RM-001` reword "clears".
